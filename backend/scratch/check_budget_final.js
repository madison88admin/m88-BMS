...
(async () => {
  const { data, error } = await supabase.from('budget_categories').select('category_code,category_name,budget_amount,used_amount,fiscal_year,department_id').limit(20);
